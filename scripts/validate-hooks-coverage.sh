...
SPEC_EVENTS="SessionStart SessionEnd UserPromptSubmit Stop PreToolUse PostToolUse PostToolUseFailure PermissionRequest Notification SubagentStart SubagentStop PreCompact"
