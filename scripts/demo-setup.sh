...
# Session 1: api-server - NEEDS ATTENTION
...
# Session 2: frontend-app - WORKING
cat > "$SESSIONS_DIR/demo-frontend-app-002.json" << EOF
{
  ...
  "status": "working",
  "last_prompt": "Fix the infinite redirect loop when session expires",
