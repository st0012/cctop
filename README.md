...
- **Activates the app:** [Claude Desktop](https://claude.com/download), [Warp](https://www.warp.dev/terminal), and other macOS hosts with a captured bundle identifier. cctop raises the host app so you can find the tab manually.
...
- If no exact target or usable captured app bundle is available, cctop opens the project folder in Finder.
