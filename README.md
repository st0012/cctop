...
- **Activates the app:** [Claude Desktop](https://claude.com/download) and other detected macOS apps. cctop brings the app to the front so you can find the tab manually.
